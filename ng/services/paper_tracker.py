...
class PaperChangeTracker:
    """Tracks and formats changes to paper fields."""

    def extract_original_fields(self, paper) -> Dict[str, Any]:
    ...
    def extract_original_authors(self, paper) -> List[str]:
    ...
    def extract_original_collections(self, paper) -> List[str]:
    ...
    def compare_simple_fields(
        self, original_fields: Dict[str, Any], updated_paper
    ) -> List[str]:
    ...
    def compare_authors(self, original_authors: List[str], updated_paper) -> List[str]:
    ...
    def compare_collections(
        self, original_collections: List[str], updated_paper
    ) -> List[str]:
    ...
    def build_complete_change_log(
        ...
        all_changes.extend(self.compare_simple_fields(original_fields, updated_paper))

        # Compare authors
        all_changes.extend(self.compare_authors(original_authors, updated_paper))

        # Compare collections
        all_changes.extend(
            self.compare_collections(original_collections, updated_paper)
        )

        return all_changes

    def format_change_log_details(self, paper_id: int, changes: List[str]) -> str:
