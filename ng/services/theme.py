...
class ThemeService:
    ...
    @classmethod
    def get_colors(cls, app: Optional["App"] = None, theme_name: Optional[str] = None) -> Dict[str, str]:
        """
    ...
    @classmethod
    def get_color(cls, color_name: str, app: Optional["App"] = None, theme_name: Optional[str] = None) -> str:
        """
    ...
    @classmethod
    def get_markup_color(cls, color_name: str, app: Optional["App"] = None, theme_name: Optional[str] = None) -> str:
        """
    ...
    @classmethod
    def is_light_theme(cls, app: Optional["App"] = None, theme_name: Optional[str] = None) -> bool:
        """
