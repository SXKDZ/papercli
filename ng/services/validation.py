...
class ValidationService:
    ...
    def validate_arxiv_id(arxiv_id: str) -> Tuple[bool, str]:
        ...
        if not clean_id:
            return False, "Invalid arXiv ID format. Expected format: 2307.10635 or arXiv:2307.10635"
        ...
        if not (old_format or new_format):
            return False, "Invalid arXiv ID format. Expected format: 2307.10635 or astro-ph/0506001"
